          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="relative z-0 w-full mb-5 group">
              <input
                ...
                name="email"
                id="email"
                className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2  appearance-none   dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer"
                placeholder=" "
              />
              <label
                htmlFor="email"
            ...
            {formik.errors.email && formik.touched.email && (
              <div
                className="p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50  dark:text-red-400"
                role="alert"
              >
                {formik.errors.email}
              </div>
            ...
            <div className="flex items-center justify-between">
              <button
                type="submit"
                className="tr3  bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center "
              >
                Send code
              </button>
            </div>
